      ...
      <div className="w-full px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between h-12">
          ...
          <div className="hidden lg:flex flex-1 justify-center space-x-10 items-center">
            <Link href="/register-company" className="text-[13px] font-medium text-gray-700 hover:text-navy transition-all duration-200 whitespace-nowrap relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-navy after:transition-all after:duration-200 hover:after:w-full">
              Register a company
            </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-gray-100 pt-4">
            <div className="flex flex-col space-y-4">
              <Link href="/register-company" className="text-sm font-medium text-gray-700 hover:text-navy" onClick={() => setIsMenuOpen(false)}>
                Register a company
              </Link>
