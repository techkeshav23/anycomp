      ...
      <div className="pt-20 min-h-screen bg-slate-50">
        ...
        <div className="bg-slate-950 text-white py-16">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <Link href="/register-company" className="inline-flex items-center py-3 px-8 text-base font-semibold bg-blue-600 text-white rounded-lg no-underline hover:bg-blue-700 transition-colors">
              Get Started Now
            </Link>
          </div>
        </div>
